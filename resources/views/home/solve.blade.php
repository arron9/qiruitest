...
@section('title', '解决方案')
@section('keywords', '解决方案')
@section('description', '解决方案')
@section('content')
    <div class="banner">
                ...
                <div class="product-text one">
                            ...
                            <div class="ProductList">
                                <dl class="clearfix">
                                    ...
                                    <dd>
                                        <strong><a href="/Product/p-112-110.html"> qirui CFC系列定制型各波段上/下变频器</a></strong>
                                        <p>
                                            qirui CFC系列定制型各波段上/下变频器是可根据用户需求进行定制的微波/毫米波设备，内部可配置多路上变频通道、下变频通道和频率合成本振，主要应用于微波/毫米波雷达系统和通信系统等相关领域。更多其他产品内容可…<a href="/Product/p-112-110.html">[详情]</a></p>
                                    </dd>
                                </dl>
                            </div>
                            ...
                            <div class="ProductList">
                                <dl class="clearfix">
                                    ...
                                    <dd>
                                        ...
                                        <p>
                                            qirui FFC1000系列全频带微波宽带变频器基于骐锐科技创新的OBT-HU 一体化仪表平台和成熟微波毫米波上下变频技术，实现宽带上变频功能，仪表化操作界面，便于实验室和外场使用。更多其他产品内容可咨询：400-621-8906…<a href="/Product/p-111-110.html">[详情]</a></p>
                                    </dd>
                                </dl>
                            </div>
